export const WavesArrowUp = ({
  ...
  return (
    <svg
      ...
      className="lucide lucide-waves-arrow-up-icon lucide-waves-arrow-up"
    >
      <path d="M12 2v8" />
...
export const WavesArrowDown = ({
  ...
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className="lucide lucide-waves-arrow-down-icon lucide-waves-arrow-down"
    >
      <path d="M12 10L12 2" />
