...
export const fetchMarineData = async (lat: number, lng: number) => {
  ...
  const marineData = {
    hourly: {
      ...
      wave_direction: hourly.variables(1)!.valuesArray()!,
      wave_period: hourly.variables(2)!.valuesArray()!,
      swell_wave_height: hourly.variables(3)!.valuesArray()!,
      swell_wave_direction: hourly.variables(4)!.valuesArray()!,
      swell_wave_period: hourly.variables(5)!.valuesArray()!,
      secondary_swell_wave_height: hourly.variables(6)!.valuesArray()!,
      secondary_swell_wave_period: hourly.variables(7)!.valuesArray()!,
      secondary_swell_wave_direction: hourly.variables(8)!.valuesArray()!,
      sea_surface_temperature: hourly.variables(9)!.valuesArray()!,
    },
  }
